...
class Agent:
    ...
    def __init__(self, num_state, num_action):
        ...
        # 0.4 m/s Act LR : 1e-5, Critic LR : 1e-4 tau : 5e-5
        # 0.8 m/s Act LR : 1e-7, Critic LR : 1e-6 tau : 5e-5 
...
#
            ...
            s_batch = normalize(s_batch)
            a_batch = normalize(a_batch) 
            r_batch = normalize(r_batch) 
            next_s_batch = normalize(next_s_batch)
