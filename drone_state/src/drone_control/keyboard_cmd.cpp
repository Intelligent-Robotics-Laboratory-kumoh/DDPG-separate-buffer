...
int main(int argc, char **argv)
{
    ...
    ros::Publisher position_pub = nh.advertise<geometry_msgs::PoseStamped>("/mavros/setpoint_position/local", 10);
...
//		velocity_pub.publish(remap_vel()); 
    ...
    //pose.pose.orientation.z = 0.258819;
    //pose.pose.orientation.w = 0.965926;
