...
TEST(common, VISION_TARGET)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::VISION_TARGET packet_in{};
    packet_in.timestamp = 93372036854775807ULL;
    packet_in.XY_pgain = 73.0;
    packet_in.XY_igain = 101.0;
    packet_in.XY_dgain = 129.0;
    packet_in.Z_pgain = 157.0;
    packet_in.Z_igain = 185.0;
    packet_in.Z_dgain = 213.0;
    packet_in.vision_tracking_trig = 101;

    mavlink::common::msg::VISION_TARGET packet1{};
    mavlink::common::msg::VISION_TARGET packet2{};
    ...
    EXPECT_EQ(packet1.timestamp, packet2.timestamp);
    EXPECT_EQ(packet1.XY_pgain, packet2.XY_pgain);
    EXPECT_EQ(packet1.XY_igain, packet2.XY_igain);
    EXPECT_EQ(packet1.XY_dgain, packet2.XY_dgain);
    EXPECT_EQ(packet1.Z_pgain, packet2.Z_pgain);
    EXPECT_EQ(packet1.Z_igain, packet2.Z_igain);
    EXPECT_EQ(packet1.Z_dgain, packet2.Z_dgain);
    EXPECT_EQ(packet1.vision_tracking_trig, packet2.vision_tracking_trig);
}

#ifdef TEST_INTEROP
TEST(common_interop, VISION_TARGET)
{
    mavlink_message_t msg;
    ...
    mavlink_vision_target_t packet_c {
    ...
    mavlink_msg_vision_target_encode(1, 1, &msg, &packet_c);
    ...
    EXPECT_EQ(packet_in.timestamp, packet2.timestamp);
    EXPECT_EQ(packet_in.XY_pgain, packet2.XY_pgain);
    EXPECT_EQ(packet_in.XY_igain, packet2.XY_igain);
    EXPECT_EQ(packet_in.XY_dgain, packet2.XY_dgain);
    EXPECT_EQ(packet_in.Z_pgain, packet2.Z_pgain);
    EXPECT_EQ(packet_in.Z_igain, packet2.Z_igain);
    EXPECT_EQ(packet_in.Z_dgain, packet2.Z_dgain);
    EXPECT_EQ(packet_in.vision_tracking_trig, packet2.vision_tracking_trig);
