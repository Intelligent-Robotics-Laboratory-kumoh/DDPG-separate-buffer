...
from drl_uav.srv import getRLflag, getRLflagResponse
...
def main_loop():
    ...
    # 2) take action
    num_state = 7   # state=[UAV_height, UAV_vertical_vel, , UAV_Att_Setpoint.thrust]
    num_action = 4  # action=[0,1]
